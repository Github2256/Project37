class Form{
   ...
   // this.input1 = createInput("Enter your name here!!");
    ...
    // this button is for moving to the next page;
                   /////
    ...
    this.Note = createElement('h4');
              ...
              //////
    this.text = createElement('h1b');
    this.text1 = createElement("h1c");
    this.text2 = createElement("h1d");
    this.text3 = createElement("h1e");
               //////
    }
 hide() {
    this.greeting.hide();
...
if(contestant.answer === "1:Everyone"){
this.text1.html(contestant.name + ": " + contestant.answer)
this.text1.position(100,300);
}

 if(contestant.answer === "2:Envelope" ) {
    this.text.html(contestant.name + ": " + contestant.answer);
    this.text.position(100,300);
 }

 if(contestant.answer === "3:Estimate" ) {
    this.text2.html(contestant.name + ": " + contestant.answer);
    this.text2.position(100,300);
 }

 if(contestant.answer === "4:Example" ) {
    this.text3.html(contestant.name + ": " + contestant.answer);
    this.text3.position(100,300);
 }
